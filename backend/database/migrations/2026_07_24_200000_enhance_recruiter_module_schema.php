...
/**
 * Original MySQL-oriented recruiter enhancement.
 * Made idempotent/SQLite-safe so later runtime migrations can coexist.
 */
        ...
        if (Schema::hasTable('notifications')) {
            try {
                DB::statement("ALTER TABLE notifications MODIFY type ENUM(
                    'booking','payment','review','system','application','interview','offer','job','recruiter','unlock','withdraw'
                ) NOT NULL");
            } catch (\Throwable $e) {
